...
erst wenn an den Coding-Agenten zurückgemeldet wird, dass eure Testsuite, der
...
Python unterstützt euch dabei, da sie hervorragende Fehlermeldungen generiert,
die direkt an den Coding-Agenten zurückgegeben werden kann; je mehr Hinweise
oder sogar Lösungsvorschläge sie enthalten, desto besser.
