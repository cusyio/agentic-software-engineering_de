...
<https://code.claude.com/docs/de/memory#how-claude-md-files-load>`_, `AGENTS.md
<https://agents.md/>`_ oder `SKILL.md <https://agentskills.io/home>`_ im
:doc:`Git <Python4DataScience:productive/git/index>`-Repository gemeinsam
verwalten.
